<template>
  ...
  <!-- 选择商品分类区 -->
  <el-row class="cat_opt" type="flex" align="middle">
    <el-col :span="3" >
      <span>选择商品分类:</span>
    </el-col>
    <el-col :span="21">
...
export default {
  ...
  methods: {
    ...
    // 控制参数/属性编辑的对话框的显示与隐藏
    // 这里不进行请求也可以，直接从 scope.row.attr_name中获取
